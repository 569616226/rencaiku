                ...
                <div>
                    <div class="main-content padding">
                        <div class="add-order-header">
                            <i class="iconfont">&#xe601;</i>
                            <span class="margin-left-xs">请选择人员增补申请单后才可以新建预约</span>
                        </div>
                        <form class="form-horizontal margin-top add-order-form" id="add_form">
                            <div class="form-group">
                                ...
                                <div class="col-sm-6 check-modal" id="rymodal">
                                    @if(isset($examine))
                                        <input type="text" id="examine_val" name="examine_val" value="{{ $examine->apply_name.'的人员申请单'}}" class="form-control" readonly="readonly" placeholder="请选择" datatype="*" nullmsg="请选择人员申请增补单">
                                        <input type="hidden" id="examine_id" value="{{ $examine->id }}" name="examine_id" datatype="*" nullmsg="获取申请单id失败，请联系开发人员">
                                    @else
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    @if(isset($examine))
                                        <input type="text" id="work_zw" name="work_zw" readonly="readonly" value="{{ $examine->position }}" class="form-control" datatype="*" nullmsg="获取面试职位失败，请联系开发人员">
                                    @else
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6 check-time input-append date">
                                    <input readonly="readonly" type="text" id="offer_date" name="offer_date" class="form-control" value="" datatype="*" nullmsg="请选择面试时间" >
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6 check-modal" id="jlmodal">
                                ...
                                <div class="col-sm-6">
                                    <div class="approver" id="shrlist">
                                        ...
                                        @else
                                            <div class="approver listapp">
                                                <div class="approver_o">
                                                    <input type="hidden"  name="user_id" value="{{ $user_first->id }}" >
                                                    <img src="{{ $user_first->avatar }}" class="img-responsive">
                                                    <p>{{ $user_first->name }}</p>
                                                </div>
                                                <div class="approver_di">···</div>
                                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <div class="approver listapp">
                                        <div class="approver_o">
                                            <img src="{{ isset($subscribe) ? $users[1]->avatar : $user_last->avatar  }}" class="img-responsive">
                                            <p>{{ isset($subscribe) ? $users[1]->name : $user_last->name }}</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
//                var radioobj = $("input[name='examine']:checked");   //获取到被选中的单选框的对象
//                var strhtml1 = radioobj.parents('tr').find('td').eq(1).text();  //获取到第2列的html()
//                var strhtml4 = radioobj.parents('tr').find('td').eq(4).text();  //获取到第5列的html()
//                $("#examine_id").val(radioobj.val());
//                $("#examine_val").val(strhtml1);
//                $("#work_zw").val(strhtml4);
//                $('#choose_ry_modal').modal('hide');
            });
