                                        ...
                                        <div class="card ng-scope" data-ng-controller="tableCtrl as datatable">
                                            <div class="card-block">
                                                <div id="DataTables_Table_0_wrapper"
                                                     class="form-inline dt-bootstrap4 no-footer">
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <table class="table" ui-jq="dataTable"
                                                                   ui-options="datatable.dataTableOpt"
        ...
        require(['DataTable', 'layer'], function (DataTable) {
            $(function () {
                var table = $('#DataTables_Table_0').DataTable({
                    "ajax": "/data/table_off_data?time=3",
                    "ordering": false,
                    "bAutoWidth": true,
                    "searching": false,
                    "columnDefs": [
                ...
                $('.statistics_time_span').on('click', function () {
                    ...
                    table.ajax.url('/data/table_off_data?time=' + time).load()
                })
                if(GetQuery('time') == '1'){
    	    		setTimeout(function(){
