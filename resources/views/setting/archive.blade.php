        ...
        <div class="row hr-main-bg">
            ...
            <div class="right-side col-xs-12 col-sm-10 col-md-9 col-lg-10 padding-bottom">
                <div class="right-side-header margin-left">
                    <p style="font-size: 16px;padding-top: 2rem;padding-bottom: 2rem; border-bottom: #E3E3E3 1px solid">薪资信息查看设置</p>
                </div>
                <div class="main-content padding afterboottom">
                    <div class="clearfix" style="margin-bottom: 20px;">
                        ...
                        <div class="pull-left">
                            ...
                            <div class="approver_text margin-0">只有设置指定人员，才可以查看/操作全公司人员的人事档案-薪资信息；其余人只能查看自己档案。</div>
                        </div>
                    </div>
                </div>
...
//               if(user_ids.length){
                var url = '/setting/archive'
                AjaxJson(url,{'archives':user_ids},function (data) {
                    layer.msg(data.msg);
                    setTimeout(function () {
