...
<div class="container">
	@if($archives['archive_year_counts'])
	<div class="myjob_index">
		{{--<p class="myjob_time_p">1月1日-1月7日</p>--}}
			@foreach($archives['archive_years'] as $archive_agree)
				...
				@endif
			@endforeach
			<a class="btn_show_oldnotice_ol" href="{{ url( '/mobile/notice/history/year' ) }}">查看已完成待办</a>
		</div>
	@else
		<div class="text-center">
			<img style="max-width: 80%" src="{{ url('img/raw_1501664235.png') }}" alt="">
			<p>当前没有要完成的待办！</p>
			<a class="btn_show_oldnotice" href="{{ url( '/mobile/notice/history/year' ) }}">查看已完成待办<i class="iconfont icon_btn_show_oldnotice"></i></a>
		</div>
	@endif
