...
<div class="container">
		<div class="myjob_index">
			<div class="home_con_center">
				<a class="btn_show_oldnotice" href="{{ url( '/mobile/notice/families' ) }}">隐藏已完成待办<i class="iconfont icon_btn_show_oldnotice_top"></i></a>
			</div>
