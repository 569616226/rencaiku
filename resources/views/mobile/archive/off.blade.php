...
<html lang="zh-CN">
	...
	<body>
		...
		<script>
            ...
            var url = '/mobile/archive/get_off/'+'{{ $depart_id }}';
            ...
            $('#endTaskBtn').on('click', function () {
                ...
                let word = $('#word').val()
                window.location.href = '/mobile/archive/'+'{{ $depart_id }}'+'/search_off?offer_status='+status+'&offer_depart='+depart+'&keyWord='+encodeURI(encodeURI(word))
            });

            $('.search_letter_btn').on('click', function () {
                let keyWord = $('#keyWord').val()
                window.location.href = '/mobile/archive/'+'{{ $depart_id }}'+'/search_off?keyWord='+encodeURI(encodeURI(keyWord))
            });
		</script>
	</body>
