	...
	<body>
		...
		<script>
			...
			* */
            ...
            var url = host + '/mobile/archive/search_on_data/'+'{{ $depart_id }}';
            ...
            $('#endTaskBtn').on('click', function () {
                ...
                let word = $('#word').val()
                window.location.href = '/mobile/archive/'+'{{ $depart_id }}'+'/search_on?offer_status='+status+'&offer_depart='+depart+'&keyWord='+encodeURI(encodeURI(word))
            });

            $('.search_letter_btn').on('click', function () {
                let keyWord = $('#keyWord').val()
                window.location.href = '/mobile/archive/'+'{{ $depart_id }}'+'/search_on?keyWord='+encodeURI(encodeURI(keyWord))
            });
		</script>
	</body>
