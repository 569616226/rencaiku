(function($) {
	...
	var settings = {
		...
		'offset': '100',
		'data': {},
		'spinner_code': '<img src="/img/loader.gif" width="20" height="20"> 数据加载中...'
	}
	...
	var methods = {
		init: function(options) {
			return this.each(function() {
				...
				if(settings.scroll == 'false') {
					$(this).find(settings.trigger).on('click.more', methods.get_data);
					$(this).more('get_data');
				} else {
		...
		get_data: function() {
			...
			if(variables.last >= cur_last) {
				...
				$.get(settings.address, postdata, function(data) {
